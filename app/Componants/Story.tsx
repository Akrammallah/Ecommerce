...
const Story = () => {
  return (
    <>
    <p>Home/About</p>
    <div className='  grid grid-cols-1 sm:grid-cols-2 justify-items-center justify-between '>
      ...
      <div>
        <Image className='rounded-md' src={img} alt='' width={705} height={609}/>
      </div>
    </div>
    <div className='flex justify-evenly items-center mt-12 mb-12'>
...
<div className='border-1 border-gray-400 hover:bg-red-800 p-4 rounded-md'><Image className='ml-8' src={img2} alt=''/>
      <p className='text-center mt-4'>10.5k </p>
